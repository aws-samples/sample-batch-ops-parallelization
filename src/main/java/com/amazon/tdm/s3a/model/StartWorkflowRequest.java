...
public class StartWorkflowRequest extends Object  {

  /**
   * Statically creates a builder instance for StartWorkflowRequest.
   */
  ...
  /**
   * Fluent builder for instances of StartWorkflowRequest.
   */
  public static class Builder {
     ...
     */
    protected void populate(StartWorkflowRequest instance) {
      instance.setNamespaceID(this.namespaceID);
      instance.setWorkflowName(this.workflowName);
    }

    /**
     * Builds an instance of StartWorkflowRequest.
     * <p>
     * The built object has its fields set to the values given when calling the "with*" methods of this builder.
     * </p>
     */
    public StartWorkflowRequest build() {
      StartWorkflowRequest instance = new StartWorkflowRequest();
  ...
  private static final int classNameHashCode =
      internalHashCodeCompute("com.amazon.tdm.s3a.StartWorkflowRequest");

  /**
   * HashCode implementation for StartWorkflowRequest
  ...
  /**
   * Equals implementation for StartWorkflowRequest
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof StartWorkflowRequest)) {
      return false;
    }

    StartWorkflowRequest that = (StartWorkflowRequest) other;
  ...
  public String toString() {
    ...
    ret.append("StartWorkflowRequest(");
