...
public class DeleteWorkflowRequest extends Object  {

  /**
   * Statically creates a builder instance for DeleteWorkflowRequest.
   */
  ...
  /**
   * Fluent builder for instances of DeleteWorkflowRequest.
   */
  public static class Builder {
     ...
     */
    protected void populate(DeleteWorkflowRequest instance) {
      instance.setNamespaceID(this.namespaceID);
      instance.setWorkflowName(this.workflowName);
    }

    /**
     * Builds an instance of DeleteWorkflowRequest.
     * <p>
     * The built object has its fields set to the values given when calling the "with*" methods of this builder.
     * </p>
     */
    public DeleteWorkflowRequest build() {
      DeleteWorkflowRequest instance = new DeleteWorkflowRequest();
  ...
  private static final int classNameHashCode =
      internalHashCodeCompute("com.amazon.tdm.s3a.DeleteWorkflowRequest");

  /**
   * HashCode implementation for DeleteWorkflowRequest
  ...
  /**
   * Equals implementation for DeleteWorkflowRequest
  ...
  public boolean equals(final Object other) {
    ...
    if (!(other instanceof DeleteWorkflowRequest)) {
      return false;
    }

    DeleteWorkflowRequest that = (DeleteWorkflowRequest) other;
  ...
  public String toString() {
    ...
    ret.append("DeleteWorkflowRequest(");
