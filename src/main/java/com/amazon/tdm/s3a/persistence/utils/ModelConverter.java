...
public final class ModelConverter {
    ...
    private static RuntimeConfig setRuntimeConfig(final com.amazon.tdm.s3a.model.RuntimeConfig runtimeConfig) {
        if (runtimeConfig != null) {
            ...
            if (runtimeConfig.getManifestLocation() != null) {
                Optional.ofNullable(runtimeConfig)
                        .map(com.amazon.tdm.s3a.model.RuntimeConfig::getManifestLocation)
